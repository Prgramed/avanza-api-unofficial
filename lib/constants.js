 ...
 */
constants.paths = {}
constants.paths.POSITIONS_PATH = '/_api/position-data/positions/{0}' // Updated to new position-data API format
constants.paths.OVERVIEW_PATH = '/_api/trading-critical/rest/accounts'
constants.paths.ACCOUNTS_LIST_PATH = '/_api/account-overview/accounts/list' // New endpoint for listing all accounts
